...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        var _this = this;
        return this.http.post("api/auth/session", { 'userName': username, password: password })
    ...
    AuthenticationService.prototype.samlLogin = function (token) {
        var loggedInUser = { id: 2, username: 'demandfarm', firstName: 'SAML', lastName: 'Test' };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getAllAccounts = function () {
...
/* harmony import */ var _saml_success_saml_success_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./saml-success/saml-success.component */ "./src/app/saml-success/saml-success.component.ts");
/* harmony import */ var _saml_failure_saml_failure_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./saml-failure/saml-failure.component */ "./src/app/saml-failure/saml-failure.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _saml_success_saml_success_component__WEBPACK_IMPORTED_MODULE_9__["SamlSuccessComponent"],
                _saml_failure_saml_failure_component__WEBPACK_IMPORTED_MODULE_10__["SamlFailureComponent"]
            ],
            providers: [
...
/* harmony import */ var _saml_success_saml_success_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./saml-success/saml-success.component */ "./src/app/saml-success/saml-success.component.ts");
/* harmony import */ var _saml_failure_saml_failure_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./saml-failure/saml-failure.component */ "./src/app/saml-failure/saml-failure.component.ts");
...
var routes = [
    ...
    { path: 'saml-success', component: _saml_success_saml_success_component__WEBPACK_IMPORTED_MODULE_4__["SamlSuccessComponent"] },
    { path: 'saml-failure', component: _saml_failure_saml_failure_component__WEBPACK_IMPORTED_MODULE_5__["SamlFailureComponent"] },
...
module.exports = "<div class=\"card mt-4\">\n    <h4 class=\"card-header\">You're logged in with Angular 8 & JWT!!</h4>\n    <!-- <div class=\"card-body\">\n        <h6>Users from secure api end point</h6>\n        <div *ngIf=\"loading\" class=\"spinner-border spinner-border-sm\"></div>\n        <ul *ngIf=\"users\">\n            <li *ngFor=\"let user of users\">{{user.firstName}} {{user.lastName}}</li>\n        </ul>\n    </div> -->\n    <div class=\"card-body\">\n        <h6>Accounts from secure api end point</h6>\n        <div *ngIf=\"loading\" class=\"spinner-border spinner-border-sm\"></div>\n        <ul *ngIf=\"accountResponse && (! accountResponse.empty)\">\n            <li *ngFor=\"let account of accountResponse.content\">{{account.name}}</li>\n        </ul>\n    </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        //     this.users = users;
        // });
        this.userService.getAllAccounts().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (accountResponse) {
            _this.loading = false;
            console.log(accountResponse);
            _this.accountResponse = accountResponse;
        });
    };
...
/***/ "./src/app/saml-failure/saml-failure.component.css":
/*!*********************************************************!*\
  !*** ./src/app/saml-failure/saml-failure.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3NhbWwtZmFpbHVyZS9zYW1sLWZhaWx1cmUuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/saml-failure/saml-failure.component.html":
/*!**********************************************************!*\
  !*** ./src/app/saml-failure/saml-failure.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/saml-failure/saml-failure.component.ts":
/*!********************************************************!*\
  !*** ./src/app/saml-failure/saml-failure.component.ts ***!
  \********************************************************/
/*! exports provided: SamlFailureComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SamlFailureComponent", function() { return SamlFailureComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services */ "./src/app/_services/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var SamlFailureComponent = /** @class */ (function () {
    function SamlFailureComponent(router, authenticationService, route) {
        this.router = router;
        this.authenticationService = authenticationService;
        this.route = route;
        if (this.authenticationService.currentUserValue) {
    ...
    SamlFailureComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log(this.route.queryParams);
        this.route.queryParams.subscribe(function (params) {
            _this.error = params['e'];
        });
    };
    SamlFailureComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-saml-failure',
            template: __webpack_require__(/*! ./saml-failure.component.html */ "./src/app/saml-failure/saml-failure.component.html"),
            styles: [__webpack_require__(/*! ./saml-failure.component.css */ "./src/app/saml-failure/saml-failure.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _services__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]])
    ], SamlFailureComponent);
    return SamlFailureComponent;
}());
...
/***/ "./src/app/saml-success/saml-success.component.css":
/*!*********************************************************!*\
  !*** ./src/app/saml-success/saml-success.component.css ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3NhbWwtc3VjY2Vzcy9zYW1sLXN1Y2Nlc3MuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/saml-success/saml-success.component.html":
/*!**********************************************************!*\
  !*** ./src/app/saml-success/saml-success.component.html ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ "./src/app/saml-success/saml-success.component.ts":
/*!********************************************************!*\
  !*** ./src/app/saml-success/saml-success.component.ts ***!
  \********************************************************/
/*! exports provided: SamlSuccessComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SamlSuccessComponent", function() { return SamlSuccessComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services */ "./src/app/_services/index.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var SamlSuccessComponent = /** @class */ (function () {
    function SamlSuccessComponent(router, authenticationService, route) {
        this.router = router;
        this.authenticationService = authenticationService;
        this.route = route;
        if (this.authenticationService.currentUserValue) {
    ...
    SamlSuccessComponent.prototype.ngOnInit = function () {
        var _this = this;
        console.log(this.route.queryParams);
        this.route.queryParams.subscribe(function (params) {
    ...
    SamlSuccessComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-saml-success',
            template: __webpack_require__(/*! ./saml-success.component.html */ "./src/app/saml-success/saml-success.component.html"),
            styles: [__webpack_require__(/*! ./saml-success.component.css */ "./src/app/saml-success/saml-success.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _services__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]])
    ], SamlSuccessComponent);
    return SamlSuccessComponent;
}());
...
module.exports = __webpack_require__(/*! D:\Exploration\ng-app-auth\src\main.ts */"./src/main.ts");
